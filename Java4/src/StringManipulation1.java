...
public class StringManipulation1 {
    ...
    private static void performStringOperations() {
        ...
        while (true) {
            ...
            System.out.println("4. Вернуть подстроку по индексам, результат сохранить в MySQL с последующим выводом в консоль.");
            System.out.println("5. Перевести строки в верхний и нижний регистры, результат сохранить в MySQL с последующим выводом в консоль.");
            System.out.println("6. Найти подстроку и определить, заканчивается ли строка данной подстрокой, результат сохранить в MySQL с последующим выводом в консоль.");
            ...
            switch (choice) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    //Возвращаем подстроку по индексам и выводим результат
                    if (stringsEntered) {
                        System.out.println("Введите начальный индекс для первой строки:");
                        int startIndex1 = scanner.nextInt();
                        System.out.println("Введите конечный индекс для первой строки:");
                        int endIndex1 = scanner.nextInt();
                        System.out.println("Подстрока первой строки: " + firstString.substring(startIndex1, endIndex1));
                        System.out.println("Введите начальный индекс для второй строки:");
                        int startIndex2 = scanner.nextInt();
                        System.out.println("Введите конечный индекс для второй строки:");
                        int endIndex2 = scanner.nextInt();
                        System.out.println("Подстрока второй строки: " + secondString.substring(startIndex2, endIndex2));
                        //Сохраняем результат в базу данных MySQL
                        System.out.println("Введите название таблицы, куда сохранить результат: ");
                        saveResultToDatabase("Подстрока (строка 1)", firstString.substring(startIndex1, endIndex1), scanner.next());
                        System.out.println("Введите название таблицы, куда сохранить результат: ");
                        saveResultToDatabase("Подстрока (строка 2)", secondString.substring(startIndex2, endIndex2), scanner.next());
                    } else {
                        System.out.println("Сначала введите строки.");
                    }
                    break;
                case 5:
                    //Переводим строки в верхний и нижний регистры и выводим результат
                    if (stringsEntered) {
                        System.out.println("Строка 1 в верхнем регистре: " + firstString.toUpperCase());
                        System.out.println("Строка 2 в верхнем регистре: " + secondString.toUpperCase());
                        System.out.println("Строка 1 в нижнем регистре: " + firstString.toLowerCase());
                        System.out.println("Строка 2 в нижнем регистре: " + secondString.toLowerCase());
                        //Сохраняем результат в базу данных MySQL
                        System.out.println("Введите название таблицы, куда сохранить результат: ");
                        saveResultToDatabase("Строка 1 (верхний регистр)", firstString.toUpperCase(), scanner.next());
                        System.out.println("Введите название таблицы, куда сохранить результат: ");
                        saveResultToDatabase("Строка 2 (верхний регистр)", secondString.toUpperCase(), scanner.next());
                        System.out.println("Введите название таблицы, куда сохранить результат: ");
                        saveResultToDatabase("Строка 1 (нижний регистр)", firstString.toLowerCase(), scanner.next());
                        System.out.println("Введите название таблицы, куда сохранить результат: ");
                        saveResultToDatabase("Строка 2 (нижний регистр)", secondString.toLowerCase(), scanner.next());
                    } else {
                        System.out.println("Сначала введите строки.");
                    }
                    break;
                case 6:
                    //Находим подстроку и определяем, заканчивается ли строка данной подстрокой, и выводим результат
                    if (stringsEntered) {
                        System.out.println("Введите подстроку для поиска в первой строке:");
                        String subStr1 = scanner.next();
                        System.out.println("Результат для первой строки: " + firstString.endsWith(subStr1));
                        System.out.println("Введите подстроку для поиска во второй строке:");
                        String subStr2 = scanner.next();
                        System.out.println("Результат для второй строки: " + secondString.endsWith(subStr2));
                        //Сохраняем результат в базу данных MySQL
                        System.out.println("Введите название таблицы, куда сохранить результат: ");
                        saveResultToDatabase("Заканчивается на " + subStr1 + " (строка 1)", String.valueOf(firstString.endsWith(subStr1)), scanner.next());
                        System.out.println("Введите название таблицы, куда сохранить результат: ");
                        saveResultToDatabase("Заканчивается на " + subStr2 + " (строка 2)", String.valueOf(secondString.endsWith(subStr2)), scanner.next());
                    } else {
                        System.out.println("Сначала введите строки.");
                    }
                    break;
