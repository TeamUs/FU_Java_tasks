...
public class PerformByteOperations {
        ...
        do {
            ...
            switch (operationChoice) {
                ...
                case 7:
                    ...
                    break;
                case 8:
                    byte absNum1 = (byte) Math.abs(num1);
                    byte absNum2 = (byte) Math.abs(num2);
                    ...
                    break;
                case 9:
                    byte power = (byte) Math.pow(num1, num2);
    ...
    private static void saveResultToDatabase(int num1, int num2, String operation, int result, String tableName) {
